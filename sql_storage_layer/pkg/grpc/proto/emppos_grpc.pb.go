...
type EmployeeServiceClient interface {
	GetEmployeeByID(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*EmployeeResponse, error)
...
func (c *employeeServiceClient) GetEmployeeByID(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*EmployeeResponse, error) {
	out := new(EmployeeResponse)
	err := c.cc.Invoke(ctx, "/EmployeeService/GetEmployeeByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmployeeServiceServer interface {
	GetEmployeeByID(context.Context, *EmployeeRequest) (*EmployeeResponse, error)
...
func (UnimplementedEmployeeServiceServer) GetEmployeeByID(context.Context, *EmployeeRequest) (*EmployeeResponse, error) {
...
func _EmployeeService_GetEmployeeByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/EmployeeService/GetEmployeeByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).GetEmployeeByID(ctx, req.(*EmployeeRequest))
	}
